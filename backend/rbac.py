...
DEFAULT_PERMISSIONS = {
    ...
    # Pemisahan tugas yang dijaga: staf DM MENGISI biaya harian (`create`), supervisor DM
    # MENGUBAH kampanye & MENGOMIT impor (`update`) serta menarik data platform / mengirim
    # ulang event ke sistem luar (`manage`). Keuangan MELIHAT (biaya iklan adalah beban yang
    # mereka bukukan) tetapi TIDAK boleh mengarang angka kampanye.
    "ads": {
        "sales_manager": ["view_all", "create", "update"],
        "marketing_admin": ["view_all", "create", "update"],
        "finance": ["view_all"], "finance_manager": ["view_all"],
